...
async function getUsageData() {
  ...
  return {
    ...
    allTime: {
      ...allTimeTotals,
      total_tokens: (allTimeTotals.total_input_tokens || 0) + (allTimeTotals.total_output_tokens || 0),
    },
    bots: bots.map(b => ({
      ...b,
