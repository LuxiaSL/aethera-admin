  ...
  return {
    comfyui: {
      ...
      gpuTypeIds: [
        ...
        'NVIDIA RTX A5000',         // Fallback - good balance
        'NVIDIA RTX A4500',         // Fallback
      ],
      gpuCount: 1,
...
async function ensurePod(templateName, options = {}) {
  ...
  try {
    ...
    // Pod is created but may need time to start
    // The creation API should start it automatically if deploy: true
